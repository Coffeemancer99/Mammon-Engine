...
from src.game.boardGame.itemInventory import PoolOfItems
...
def main():
    ...
    testingyy = PoolOfItems(None, None)  ## Don't touch this yet, this is for testing

    print(testingyy.getItemRegTileBlock())
